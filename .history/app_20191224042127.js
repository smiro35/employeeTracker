...
function addToTables() {
    ...
    var query = con.query(
        ...
        function(err, res) {
            ...
            // Call updateTables AFTER the INSERT completes
            updateTables();
        }
    );
...
//We can extend ProcessAnswer-----******
function nowAdd() {}
if (answers.Add === "Department") {
    console.log("Want to add to Dept");
    addToTables();

} else if (answers.Add === "role") {
    console.log("Want to add to role");

} else {

    console.log("Want to add Employee");
